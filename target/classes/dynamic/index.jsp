...
<%--                    </li>--%>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            //get every group form groups
                            <c:forEach items="${groups}" var="group">
                                //for every group sout its name, make group a link
    ...
    <table class="table table-striped">
        ...
        <c:forEach items="${contacts}" var="contact">
            <tr>
                //same as group
                //tr - string in the table, td - column
                //checkbox (choose smth)
...
//javaScript magic idk what's happening
<script>
    $('.dropdown-toggle').dropdown();
//when clicking on button -> go to endpoint
